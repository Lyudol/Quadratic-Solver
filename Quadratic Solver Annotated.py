...
def numerator():
    ...
    if numrootone < 0:                                               
        ...
        restarter() #Then the function from line 33 is called to allow a new equation to be input
    else:
...
def solver():
    global restarter #This globalises the embedded function from line 33 so it can be called by the function from line 12, in line 19
    def restarter(): #This embedded function just asks the user if they want to solve a new equation  
        print("--------------------------------------------------")
